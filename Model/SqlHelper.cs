...
namespace Model
{
    ...
    public abstract class SqlHelper
    {
        ...
        //public static readonly string ConnectionStringLocalTransaction = "Data Source=.;Initial Catalog=GoodsManage;User ID=sa;Password=123";
        //用配置文件登录数据库
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["BenqOAContext"].ConnectionString;
